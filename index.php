...
<html>
	<head>
		...
		<title>Millennium Physician Group</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
			<h1 style="color:black">Powered by <a href="http://mobilegrows.com/" rel="external">MobileGrows</a> | <a href="http://www.grammaspizza.net/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
<!-- pop up for telefon -->
			...
			<!-- POPUP FOR FIND US -->
				...
				<a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Pizza</a>
				<a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Sandwiches</a>
				<a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">Salads and MORE</a>
			...
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Pizza</a></li>
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Sandwiches</a></li>
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Salads and MORE</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Locations</a></li>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-contact">
							<ul id="menu-contact">
                                ...
                                <li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Sandwiches</a></li>
                                <li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Salads and MORE</a></li>
                                <li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Locations</a></li>
                                <li><a href="#contactform" data-transition="<?php echo $transitionefect ?>">Contact</a></li>
							</ul>
					</section>
					<div>	
